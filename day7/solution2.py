...
root_node_full_size = root_node.full_size()
target_delete_size = 30000000 - (70000000 - root_node_full_size)

delete_directory_size = 100000000
for s in full_sizes:
	if s > target_delete_size and s < delete_directory_size:
		delete_directory_size = s
